...
class ParserFacade
{
	...
	{
		if (NULL === $this->parser) {
			$tagDefinitions = new TagDefinitions(require '/home/xui/includes/libs/resources/tags.php');
			$this->parser = new Parser($tagDefinitions, new Config(require '/home/xui/includes/libs/resources/tagValueParsers.php'), new DataBuilder());
		}
...
class DumperFacade
{
	...
	public function dump(ArrayAccess $data, StreamInterface $stream)
	{
		if (NULL === $this->dumper) {
			$tagDefinitions = new TagDefinitions(require '/home/xui/includes/libs/resources/tags.php');
			$this->dumper = new Dumper($tagDefinitions, new Config(require '/home/xui/includes/libs/resources/tagValueDumpers.php'));
		}
