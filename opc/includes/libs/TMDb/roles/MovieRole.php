...
class MovieRole
{
	...
	public function __construct($data, $idPerson)
	{
		...
		2  26  ASSIGN_OBJ/136            ?0        ?0                   0:'_data'           	;0
		3  26  OP_DATA/137               ?0        16?0                 ?0                  	;0
		4  28  INIT_STATIC_METHOD_CALL/113 ?0        ?514                 ?1669238688         	;2
	...
	public function getMovieTitle()
	{
		...
		1  41  FETCH_DIM_R/81            $1=       $0                   1:'title'           	;0
	...
	public function getMovieOriginalTitle()
	{
		...
		1  59  FETCH_DIM_R/81            $1=       $0                   1:'original_title'  	;0
	...
	public function getMovieReleaseDate()
	{
		...
		1  68  FETCH_DIM_R/81            $1=       $0                   1:'release_date'    	;0
...
1  12  DECLARE_INHERITED_CLASS/140 $1=       2:'movierole'        $0                  	;4294967295
