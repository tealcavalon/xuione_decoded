...
class MovieRole
{
	...
	public function __construct($Ae757d5b26893bfe, $Bb6efcdf5168c97c)
	{
		...
		2  8   ASSIGN_OBJ/136            ?0        ?0                   0:'_data'           	;0
		3  8   OP_DATA/137               ?0        16?0                 ?0                  	;0
		4  9   INIT_STATIC_METHOD_CALL/113 ?0        ?514                 ?1660906944         	;2
	...
	public function getMovieTitle()
	{
		...
		1  13  FETCH_DIM_R/81            $1=       $0                   1:'title'           	;0
	...
	public function getMovieOriginalTitle()
	{
		...
		1  21  FETCH_DIM_R/81            $1=       $0                   1:'original_title'  	;0
	...
	public function getMovieReleaseDate()
	{
		...
		1  25  FETCH_DIM_R/81            $1=       $0                   1:'release_date'    	;0
...
1  3   DECLARE_INHERITED_CLASS/140 $1=       2:'movierole'        $0                  	;4294967295
